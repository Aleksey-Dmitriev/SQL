...
1
Выведите значение колонки ContactName
SELECT ContactName 
from otusQA
2
Выведите все возможные значения колонки Country
SELECT DISTINCT Country
from otusQA
3
Выведите все записи, где City имеет значение London
SELECT *
from otusQA
WHERE City = 'London'
4
Выведите все записи, где City не равен London
SELECT *
from otusQA
WHERE City != 'London'
5
Выберите все записи, где Country равна Mexico и Postal Code 05021
SELECT *
from otusQA
WHERE country = 'Mexico' AND postalcode = '05021'
6
Выберете все записи у которых Country равна Mexico или Sweden
SELECT *
from otusQA
